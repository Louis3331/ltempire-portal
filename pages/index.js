    ...
    <>
      ...
      <div style={styles.page}>
        ...
        <div style={styles.card}>
          ...
          <button style={styles.btn} onClick={() => signIn('whop', { callbackUrl: '/dashboard' })}>
...
const styles = {
  ...
  card: {
    ...
    maxWidth: 420,
    textAlign: 'center',
    boxShadow: '0 0 60px rgba(201,168,76,0.06), 0 24px 48px rgba(0,0,0,0.5)',
  ...
  divider: {
    height: 1,
    background: 'linear-gradient(90deg, transparent, #2a2208, transparent)',
    margin: '24px 0',
  },
  desc: {
    fontSize: 14,
